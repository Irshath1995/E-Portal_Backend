...
import com.infotel.e_portal.exceptionHandler.BannerOperationException;
...
import com.infotel.e_portal.service.BannerService;
...
public class BannerServiceImpl implements BannerService {
	...
	public ResponseEntity<String> uploadBanner(List<MultipartFile> banners) {
		try {
			...
			throw new BannerOperationException("Banner image upload failed: " + e.getMessage());
		}
	}
	...
	public ResponseEntity<String> deleteBanner(List<String> bannerImageName) {
		try {
			...
			throw new BannerOperationException("Banner image deletion failed: " + e.getMessage());
		}
	}
	...
	public List<String> getAllBanners() {
		...
		try {	
			...
			throw new BannerOperationException("Error retrieving banners: " + e.getMessage());
		}
